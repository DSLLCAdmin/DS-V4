    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1A0F0A] via-[#8B4513] to-[#D2691E] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          {/* Product Image - Left Column (Full Height) */}
          <div className="space-y-6">
            <ScrollReveal>
              <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-gradient-to-br from-swatch101/95 to-swatch101/85 backdrop-blur-sm border border-swatch103/30">
                <div className="relative w-full h-[600px] bg-gradient-to-br from-swatch205/10 to-swatch205/5 rounded-2xl overflow-hidden">
                  {(!product.image || product.image === "" || product.image.startsWith('Product in-Design') || product.image === "Need Image Here" || product.image.includes('placeholder') || product.image.includes('Placeholder')) ? (
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-swatch101/40 to-swatch102/30 border-2 border-swatch101/20">
                      <div className="text-center p-6">
                        ...
                        <p className="text-xl font-bold text-white mb-1 drop-shadow-lg font-extrabold underline decoration-2 underline-offset-4">Product in-Design</p>
                        <p className="text-base text-white font-bold drop-shadow-md">Tell us your ideas!</p>
                      </div>
                    </div>
                  ) : (
                    <img
                ...
                {(product.id === "1a" || product.badge === "New" || product.badge === "Best Seller") && (
                  <Badge className="absolute top-4 right-4 bg-gradient-to-r from-swatch102 to-swatch103 text-white border-2 border-white font-bold text-xs px-3 py-1 shadow-lg animate-pulse z-10">
                    ⭐ FEATURED
                  </Badge>
                )}
              </div>
            ...
            {/* Price and Contact Buttons - Below Image */}
                  ...
                  <div className="text-center">
                    ...
                    {formatPrice(product.price) === "Contact for Price" ? (
                      <div className="space-y-3">
                        <p className="text-3xl font-black text-white mb-2">Contact for Price</p>
                        <p className="text-white font-medium">Special pricing available</p>
                      </div>
                    ) : (
            ...
            <ScrollReveal delay={200}>
              <div className="space-y-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  {(!product.image || product.image === "" || product.image.startsWith('Product in-Design') || product.image === "Need Image Here" || product.image.includes('placeholder') || product.image.includes('Placeholder')) && (
                    <Badge className="bg-swatch102/90 text-white border-swatch102 font-bold text-xs px-3 py-1.5 flex-shrink-0 shadow-lg">
                      🎨 IN-DESIGN
                    </Badge>
                  )}
                </div>
                ...
                {product.author && (
                  <p className="text-xl text-white font-semibold italic drop-shadow-sm">
                    by {product.author}
                  </p>
                )}
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-lg font-bold text-white drop-shadow-sm">N/A</span>
                  </div>
                  <Badge className="bg-swatch103/20 text-white border-swatch103/30 px-3 py-1">
                    {product.category}
                  </Badge>
                </div>
              </div>
                ...
                <div className="bg-gradient-to-br from-swatch101/95 to-swatch101/85 backdrop-blur-sm rounded-2xl p-4 border border-swatch103/30">
                  ...
                  <p className="text-base text-black leading-relaxed">
                    {product.longDescription || product.description || (
                      <>
                        <DarkStreetsLogo size="2rem" /> exclusive product
                      </>
                    )}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {product.id === "1a" && (
                    <div className="bg-gradient-to-br from-swatch102/20 to-swatch103/20 rounded-2xl p-4 border border-swatch102/30">
                      ...
                      <p className="text-black leading-relaxed text-sm">
                        Meet Aries Tiger and Dance in this electrifying first chapter. Experience LA's <DarkStreetsLogo size="2rem" /> through their eyes as they cruise complexions in street culture, relationships, and self-discovery.
                      </p>
                    </div>
                  )}
                  ...
                  <div className="bg-gradient-to-br from-swatch104/20 to-swatch103/20 rounded-2xl p-4 border border-swatch104/30">
                    ...
                    <ul className="text-black leading-relaxed space-y-2 text-sm">
                      ...
                      <li className="flex items-center space-x-2">
                        <span className="text-swatch103">•</span>
                        <span>Raised by <DarkStreetsLogo size="2rem" /></span>
                      </li>
              ...
              <FloatingElement speed={0.02}>
                <div className="group flex items-center justify-center space-x-4 hover:scale-105 transition-all duration-300 p-4 rounded-xl hover:bg-swatch103/10">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-white/80 text-sm">Over $50</p>
                  </div>
                </div>
              </FloatingElement>
              <FloatingElement speed={0.025}>
                <div className="group flex items-center justify-center space-x-4 hover:scale-105 transition-all duration-300 p-4 rounded-xl hover:bg-swatch103/10">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-white/80 text-sm">100% Guaranteed</p>
                  </div>
                </div>
              </FloatingElement>
