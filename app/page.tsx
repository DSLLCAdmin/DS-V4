      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 w-full overflow-x-hidden overflow-hidden grid grid-cols-1 gap-0">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <Link href="/ds-map" className="group">
            <div className="button-dsmap nav-button">
                  ...
                  <div className="button-description">
                    <span>Discover <DarkStreetsLogo size="3em" /></span>
                    <span>For You</span>
                    <ArrowRight className="w-4 h-4 button-arrow" />
                  </div>
                </div>
          ...
          <Link href="/about" className="group">
            <div className="button-about nav-button">
              <div className="button-content">
                ...
                <p className="button-subtitle"><DarkStreetsLogo size="2em" /></p>
                <div className="button-description">
                  <span>Hear Our <DarkStreetsLogo size="3em" /></span>
                  <span>Backstory</span>
                  <ArrowRight className="w-4 h-4 button-arrow" />
                </div>
              </div>
        ...
        <div className="bg-gradient-to-b from-[#EFD907] to-[#B8A005] rounded-2xl shadow-xl p-6 mb-16 border border-swatch201/30 max-w-5xl mx-auto overflow-hidden w-full grid-item">
          <h2 className="text-3xl font-bold text-center mb-8 text-swatch205">
            Featured <DarkStreetsLogo size="4em" /> Collections
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <h3 className="font-bold text-xl mb-3 text-swatch205"><DarkStreetsLogo size="2.5em" /> Series</h3>
            ...
            <div className="text-center group">
              ...
              <p className="text-swatch205 leading-relaxed">
                <DarkStreetsLogo size="2em" /> Streeter tees, mesh bodysuits, denim jackets, and accessories that embody 
            ...
            <div className="text-center group">
              ...
              <p className="text-swatch205 leading-relaxed">
                From scent diffusers to soundscape machines, create your own <DarkStreetsLogo size="2em" /> atmosphere. 
        ...
        <div className="bg-gradient-to-b from-[#8B4513] to-swatch105 rounded-2xl p-6 mb-16 relative max-w-5xl mx-auto overflow-hidden w-full grid-item">
          <h2 className="text-3xl font-bold mb-6 text-swatch101 text-center">
            The <DarkStreetsLogo size="4em" /> Story
          </h2>
          <p className="text-lg font-bold text-swatch101/90 leading-relaxed text-center max-w-4xl mx-auto">
            <DarkStreetsLogo size="2.5em" /> extend further than our stories tell. We are everyday people, a drifting collective, rolling around in our unique way of seeing the world. Look through the eyes of Aries Tiger. Explore freedom with the Dancer. Embed with D'<DarkStreetsLogo size="2em" />ers in their restless rhythm of urban being. Join us on the <DarkStreetsLogo size="2.5em" /> where corners hold stories, shadows hide light, and every moment is truly alive.
          </p>
        ...
        <div className="text-center mb-16">
          <Link href="/shop">
            <Button className="bg-gradient-to-r from-swatch103 to-swatch104 hover:from-swatch104 hover:to-swatch105 text-white text-xl font-bold py-6 px-12 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 border-0">
              ...
              Start Your <DarkStreetsLogo size="3em" /> Journey
            </Button>
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto p-8 text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-xl font-bold">
              <DarkStreetsLogo size="3em" /> LLC
            </span>
          </div>
          <p className="text-swatch101/80 mb-2">
            Your central portal for all <DarkStreetsLogo size="2em" /> products and experiences
          </p>
          ...
          <p className="text-sm text-swatch101/60 mb-4">
            &copy; 2025 <DarkStreetsLogo size="2em" /> LLC. All rights reserved.
          </p>
